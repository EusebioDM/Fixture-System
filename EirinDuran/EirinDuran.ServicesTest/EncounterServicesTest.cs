...
namespace EirinDuran.ServicesTest
{
    ...
    public class EncounterServicesTest
    {
        ...
        public void CreateSimpleEncounter()
        {
            ...
            EncounterServices encounterServices = new EncounterServices(encounterRepo, sportRepo, teamRepo);
            encounterServices.Login = login;
        ...
        public void ListCommentsWithFollowedTeams()
        {
            ...
            UserServices userServices = new UserServices(userRepo, teamRepo)
            {
                Login = login
            };
