...
namespace EirinDuran.ServicesTest
{
    ...
    public class EncounterServicesTest
    {
        ...
        public void TestInit()
        {
            ...
            login = new LoginServices(userRepo, teamRepo, logger);
            InitializeTeams();
        }
        ...
        public void CreateSimpleEncounter()
        {
            ...
            EncounterServices encounterServices = new EncounterServices(login, encounterRepo, sportRepo, teamRepo, userRepo, logger);
